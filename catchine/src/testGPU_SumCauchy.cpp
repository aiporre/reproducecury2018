...
int main (int argc, char *argv[])
{
    ...
    // create a sum of Cauchy kernels (direct computation)
	...
	FctArr(i) = new CauchyFunction<__TYPE__>(Sigmas(i));
    ...
    // create a sum of Cauchy kernels (GPU)
    SumCauchyGpuKernel<__TYPE__,__DIMPOINT__,__DIMVECT__> GpuKer(Weights,Sigmas);
