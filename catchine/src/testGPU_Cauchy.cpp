...
int main (int argc, char *argv[])
{
    ...
    cout << endl << "Parameters: Sigma Nx Ny" << endl << endl;
    ...
    // create a Cauchy kernel (direct computation)
    CauchyFunction<__TYPE__> *Fct = new CauchyFunction<__TYPE__>(Sigma);
    SqDistScalarKernel<__TYPE__,__DIMPOINT__,TinyVector<__TYPE__,__DIMVECT__> > DirKer(Fct);
	
    // create a Cauchy kernel (GPU)
    CauchyGpuKernel<__TYPE__,__DIMPOINT__,__DIMVECT__> GpuKer(Sigma);
